        ...
        <>
            {
                !isMobile ?
                    ...
                    :
                    <div className="bg-white px-4 pt-14 pb-4 flex justify-between items-center">
                        <img src="/icons/navLogo.svg" alt="logo" className="h-7" />
                        <div className="flex items-center gap-4">
                            <div className="flex gap-2">
                                <button className="border border-[#434343] text-[#434343] font-inter rounded-md py-2 text-[12px] px-2 font-[900] cursor-pointer">
                                    ログイン
                                </button>
                                <button className="bg-[#434343] text-white rounded-md font-inter py-2 text-[12px] px-2 font-[900] cursor-pointer">
                                    サインイン
                                </button>
                            </div>
