  ...
  return (
    <div className="px-40 pb-5 bg-white">
      <div className="max-w-6xl mx-auto space-y-8 text-[14px] leading-[18px] text-[#797979] font-inter font-[500]">
        ...
        <div className="space-y-6 pl-[50px]">
          <div className="flex gap-6">
            <span className="flex-shrink-0 w-4 text-[14px] text-[#797979] text-right">*1</span>
            <p>本ページに記載のスプレッドは参考値（平均値等）であり、市場環境・流動性・時間帯等により変動します。流動性が低い時間帯等ではスプレッドが拡大し、市況が落ち着くと通常に戻る場合があります。最新の条件は取引プラットフォームでご確認ください。</p>
          </div>
          <div className="flex gap-6">
            <span className="flex-shrink-0 w-4 text-[14px] text-[#797979] text-right">*2</span>
          ...
          <div className="flex gap-6">
            <span className="flex-shrink-0 w-4 text-[14px] text-[#797979] text-right">*3</span>
