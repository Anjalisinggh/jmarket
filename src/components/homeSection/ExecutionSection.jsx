export default function ExecutionSection() {
    return (
        <div className="md:px-40 px-4 md:py-10 pb-5 md:pt-5 bg-white">
            <div className="bg-[#F8F9FA] rounded-2xl flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="md:w-[62%] w-full md:p-14 p-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-center md:items-start">
                        {/* Windows Button */}
                        <button className="bg-[#00A3FF] w-fit md:w-full font-inter text-white px-5 py-3 rounded-full font-bold flex items-center gap-3 hover:bg-[#008bdb] transition-all shadow-md hover:shadow-lg">
